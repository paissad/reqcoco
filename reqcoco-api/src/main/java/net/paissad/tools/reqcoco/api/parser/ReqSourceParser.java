...
public interface ReqSourceParser {
	...
	Requirements getRequirements() throws ReqSourceParserException;

	Collection<Requirement> getRequirements(final Version version) throws ReqSourceParserException;
